...
import { executeRepositoryGet } from './GiteaRepositoryGet';
		...
		properties: [
			...
			// Label
			{
				...
				options: [
					...
					{ name: 'Get Many', value: 'getAll', action: 'Get many of a repository s labels' },
			...
			// Milestone
			{
				...
				options: [
					...
					{ name: 'Get Many', value: 'getAll', action: 'Get many of a repository s opened milestones' },
			...
			// User
			{
				...
				options: [
					...
					{ name: 'Create OAuth2 Application', value: 'createOauth2Application', action: 'Create a new o auth2 application' },
					...
					{ name: 'Delete OAuth2 Application', value: 'deleteOauth2Application', action: 'Delete an o auth2 application' },
					...
					{ name: 'Get OAuth2 Application', value: 'getOauth2Application', action: 'Get an o auth2 application' },
					...
					{ name: 'Update OAuth2 Application', value: 'updateOauth2Application', action: 'Update an o auth2 application' },
